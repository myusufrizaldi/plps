...
public class AdminForm extends javax.swing.JFrame {
     ...
     */
    public AdminForm(Database db, Session session) {
        initComponents();
        ...
        this.lblNamaAdmin.setText("Selamat Datang, " + this.session.getadmin().getNama()+ "!");
    ...
    private void initComponents() {
        ...
        btnDaftarDosen = new CustomSecondaryButton();
        this.bImage = null;
        try {
        ...
        iconEditMataKuliah8 = new javax.swing.JLabel(this.iconEdit);
        ...
        btnDaftarMahasiswa = new CustomSecondaryButton();
        this.bImage = null;
        try {
            bImage = ImageIO.read(new File(DosenForm.class.getResource("/res/ICON-Edit.png").getFile()));
            Image image = bImage.getScaledInstance(32, 32, Image.SCALE_SMOOTH);
        ...
        btnDaftarDosen.setBackground(new java.awt.Color(236, 240, 241));
        btnDaftarDosen.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btnDaftarDosenMouseClicked(evt);
            }
        });

        iconEditMataKuliah8.setFont(new java.awt.Font("Roboto", 0, 24)); // NOI18N
        iconEditMataKuliah8.setForeground(new java.awt.Color(51, 51, 51));
        iconEditMataKuliah8.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        ...
        lblEditMataKuliah7.setText("Daftar Dosen");

        javax.swing.GroupLayout btnDaftarDosenLayout = new javax.swing.GroupLayout(btnDaftarDosen);
        btnDaftarDosen.setLayout(btnDaftarDosenLayout);
        btnDaftarDosenLayout.setHorizontalGroup(
            btnDaftarDosenLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(btnDaftarDosenLayout.createSequentialGroup()
                .addComponent(iconEditMataKuliah8, javax.swing.GroupLayout.PREFERRED_SIZE, 64, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE)
                .addComponent(lblEditMataKuliah7, javax.swing.GroupLayout.PREFERRED_SIZE, 194, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(32, 32, 32))
        );
        btnDaftarDosenLayout.setVerticalGroup(
            btnDaftarDosenLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(lblEditMataKuliah7, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE)
            .addComponent(iconEditMataKuliah8, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE)
        );

        panelWelcome.add(btnDaftarDosen, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 420, 260, 60));
        ...
        btnDaftarMahasiswa.setBackground(new java.awt.Color(236, 240, 241));
        btnDaftarMahasiswa.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btnDaftarMahasiswaMouseClicked(evt);
            }
        });
        ...
        lblEditMataKuliah.setText("Daftar Mahasiswa");

        javax.swing.GroupLayout btnDaftarMahasiswaLayout = new javax.swing.GroupLayout(btnDaftarMahasiswa);
        btnDaftarMahasiswa.setLayout(btnDaftarMahasiswaLayout);
        btnDaftarMahasiswaLayout.setHorizontalGroup(
            btnDaftarMahasiswaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(btnDaftarMahasiswaLayout.createSequentialGroup()
                .addComponent(iconEditMataKuliah, javax.swing.GroupLayout.PREFERRED_SIZE, 64, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(lblEditMataKuliah, javax.swing.GroupLayout.DEFAULT_SIZE, 202, Short.MAX_VALUE)
                .addGap(18, 18, 18))
        );
        btnDaftarMahasiswaLayout.setVerticalGroup(
            btnDaftarMahasiswaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        panelWelcome.add(btnDaftarMahasiswa, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 420, 290, 60));

        lblNamaAdmin.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        lblNamaAdmin.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblNamaAdmin.setText("Selamat Datang, namaAnu!");
        panelWelcome.add(lblNamaAdmin, new org.netbeans.lib.awtextra.AbsoluteConstraints(406, 70, 550, -1));
...
//        this.tableToDatabase();
    ...
    private void btnDaftarMahasiswaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDaftarMahasiswaMouseClicked
       
        DaftarForm daftarForm =new DaftarForm();
        daftarForm.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_btnDaftarMahasiswaMouseClicked

    private void btnDaftarDosenMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDaftarDosenMouseClicked
        // TODO add your handling code here:
        DaftarDosenForm daftarDosenForm =new DaftarDosenForm();
        daftarDosenForm.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_btnDaftarDosenMouseClicked
    ...
    private javax.swing.JPanel btnDaftarDosen;
    private javax.swing.JPanel btnDaftarMahasiswa;
    ...
    private javax.swing.JLabel iconEditMataKuliah8;
