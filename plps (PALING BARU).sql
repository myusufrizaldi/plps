...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 17 Bulan Mei 2019 pada 07.01
...
--
-- Dumping data untuk tabel `fokus`
--
...
--
-- Struktur dari tabel `mahasiswa_ambil_matkul`
--
...
--
-- Indeks untuk tabel `mahasiswa_ambil_matkul`
--
...
--
-- AUTO_INCREMENT untuk tabel `build`
--
ALTER TABLE `build`
  MODIFY `id_build` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `fokus`
--
ALTER TABLE `fokus`
  MODIFY `id_fokus` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT untuk tabel `mahasiswa_ambil_matkul`
--
ALTER TABLE `mahasiswa_ambil_matkul`
...
--
-- Ketidakleluasaan untuk tabel `build`
--
ALTER TABLE `build`
...
--
-- Ketidakleluasaan untuk tabel `mahasiswa_ambil_matkul`
--
ALTER TABLE `mahasiswa_ambil_matkul`
